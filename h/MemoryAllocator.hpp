...
public:
    ...
    void *mem_alloc(size_t number_of_bytes); // allocates a new chunk of memory                                      // using the first fit algorithm
...
private:
    ...
    void initialize();
    bool try_to_merge(BlockHeader *header); // tries to merge the currenth free block with the next one
